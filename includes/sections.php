  ...
  <!-- Services About -->
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">About the Bed and Breakfast</h4>
                ...
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">Our Rooms</h4>
                    <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
    ...
    <section id="booking" class="bg-light-gray">
        <div class="container">
            ...
            <!--marie -->
            <?php if(isset($_SESSION['arrivaldate'])){
               
                echo "fdhkslj;ajh" .  $_SESSION['arrivaldate'];
            }else{
                 include'templates/avail.php';
